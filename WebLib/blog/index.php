            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="contact.php">Admin Panel</a></li>
                    </ul>
                </div>
            </div>
        </nav>
                ...
                <div class="col-md-10 col-lg-8 col-xl-7">
                    ...
                    <div class="post-preview">
                        <a href="post.php?postid=<?php echo $icerik["post_id"]; ?>">
                            ...
                            <h3 class="post-subtitle"><?php echo substr($icerik["post_content"],0,150),"...";  ?></h3>
                        </a>
                        <p class="post-meta">
                            Paylaşan
                            <a href="#!">@oguzunbiri</a>
